...
public class PrivateKeyResolver extends KeyResolverSpi {
     ...
     */
    private PrivateKey resolveX509IssuerSerial(XMLX509IssuerSerial x509Serial) throws XMLSecurityException, KeyStoreException {
     ...
     */
    private PrivateKey resolveX509SubjectName(XMLX509SubjectName x509SubjectName) throws XMLSecurityException, KeyStoreException {
